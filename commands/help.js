...
module.exports.run = async (bot,message,args) => {
  ...
  if(!args[0]){
    ...
    .addField("**❯ Utility**", "`" + `${prefix}` + "avatar" + "`"+ ", " + "`"+ ", " + "`" + `${prefix}` + "prefix" + "`"+ ", " + "`" + `${prefix}` + "report" + "`"+ ", " + "`" + `${prefix}` + "say" + "`"+ ", " + "`" + `${prefix}` + "serverinfo" + "`"+ ", " + "`" + `${prefix}` + "config" + "`" + ", " + "`")
    .addField("**❯ Fun**", "`" + `${prefix}` + "8ball" + "`"+ ", " + "`" + `${prefix}` + "avatar" + "`"+ ", " + "`" + `${prefix}` + "cat" + "`"+ ", " + "`" + `${prefix}` + "insult" + "`"+ ", " + "`" + `${prefix}` + "rps" + "`" + ", " + "`" + `${prefix}` + "meme" + "`")
   ...
   // .addField("**❯ NSFW**", "`" + `${prefix}` + "ass" + "`"+ ", " + "`" + `${prefix}` + "pussy" + "`"+ ", " + "`" + `${prefix}` + "porngif" + "`")
    .addField("**❯ For help on a certain command use**", "**>help <command>**");
